...
public class FileUtils
{
    ...
    public static class TrademarkClassMapper
    {
        private static readonly Dictionary<int, string> Classes = new()
        {
            ...
            {30, "Coffee, tea, cocoa and artificial coffee; rice, pasta and noodles; tapioca and sago; flour and preparations made from cereals; bread, pastry and confectionery; chocolate; ice cream; sorbets and other edible ices; sugar, honey, treacle; yeast, baking powder; salt, seasonings, spices, preserved herbs; vinegar, sauces and other condiments; ice."},
            ...
            {32, "Beers; non-alcoholic beverages; mineral and aerated waters; fruit beverages and fruit juices; syrups and other preparations for making beverages."},
