...
{
    public class WithdrawalRequestApproval(Filling model, byte[] image, ApplicationInfo selectedHistory) : IDocument
    {
        ...
        void ComposeContent(IContainer container)
        {
            ...
            container
                ...
                .Column(column =>
                {
                    ...
                    {
                        FileTypes.TradeMark => "TRADEMARK WITHDRAWAL APPROVAL LETTER",
                        FileTypes.Patent => "PATENT WITHDRAWAL APPROVAL LETTER",
                        FileTypes.Design => "DESIGN WITHDRAWAL APPROVAL LETTER",
                        _ => "WITHDRAWAL APPROVAL LETTER"
                    };
                    ...
                    column.Item().Table(table =>
                    {
                        ...
                        table.Cell().Element(Block).Column(c =>
                        {
                            ...
                            var officerName = withdrawalApp?
                                .StatusHistory?
                                .LastOrDefault(s => s.afterStatus == ApplicationStatuses.Approved)?
                                .User;
