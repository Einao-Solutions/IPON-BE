...
{
    public class ChangeOfNameAck(Filling model, byte[] image, string applicationId) : IDocument
    {
        ...
        void ComposeContent(IContainer container)
        {
            ...
            container
                ...
                .Column(column =>
                {
                    ...
                    column.Item().AlignCenter().Text("CHANGE OF APPLICANT NAME ACKNOWLEDGEMENT LETTER").FontColor(Colors.Green.Darken3).FontFamily(Fonts.TimesNewRoman).FontSize(16).ExtraBold();
                    ...
                    column.Item().Table(table =>
                    {
                        ...
                        table.Cell().Element(Block).Column(c => {
                            ...
                            c.Item().Text(app?.Name).FontSize(12).FontFamily(Fonts.TimesNewRoman);
                        });
                    });
