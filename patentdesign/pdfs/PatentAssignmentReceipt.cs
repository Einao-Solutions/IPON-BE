...
{
    public class PatentAssignmentReceipt(Receipt receipt, string url, Filling model) : IDocument
    {
        string nairaSymbol = "\u20A6";
        ...
        void ComposeContent(IContainer container)
        {
            container
                ...
                .Column(column =>
                {
                    ...
                    column.Item().AlignCenter().Text("PATENT ASSIGNMENT RECEIPT").FontColor(Colors.Green.Darken3).FontFamily(Fonts.TimesNewRoman).FontSize(16).ExtraBold();
