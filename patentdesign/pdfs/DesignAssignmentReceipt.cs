...
{
    public class DesignAssignmentReceipt : IDocument
    {
        ...
        public DesignAssignmentReceipt(Receipt receipt, string url, Filling model)
        {
        ...
        private void ComposeContent(IContainer container)
        {
            container
                ...
                .Column(column =>
                {
                    ...
                    column.Item().AlignCenter().Text("DESIGN ASSIGNMENT RECEIPT")
                        .FontColor(Colors.Green.Darken3).FontFamily(Fonts.TimesNewRoman)
                    ...
                    column.Item().Table(table =>
                    {
                        ...
                        if (!string.IsNullOrWhiteSpace(receipt.Amount) &&
                            long.TryParse(receipt.Amount, out var parsedAmount))
                        {
