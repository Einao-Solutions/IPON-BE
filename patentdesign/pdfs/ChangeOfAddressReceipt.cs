...
{
    public class ChangeOfAddressReceipt(Filling model, string appId) : IDocument
    {
        string nairaSymbol = "\u20A6";
        ...
        void ComposeContent(IContainer container)
        {
            container
                ...
                .Column(column =>
                {
                    ...
                    column.Item().AlignCenter().Text("CHANGE OF APPLICANT ADDRESS PAYMENT RECEIPT").FontColor(Colors.Green.Darken3).FontFamily(Fonts.TimesNewRoman).FontSize(16).ExtraBold();
                    ...
                    column.Item().Table(table =>
                    {
                        ...
                        table.Cell().Element(Block).Column(c => {
                            ...
                            c.Item().Text("CLD0011").FontSize(12).FontFamily(Fonts.TimesNewRoman);
                        });
                    });
