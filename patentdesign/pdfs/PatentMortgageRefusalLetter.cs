...
{
    public class PatentMortgageRefusalLetter : IDocument
    {
        ...
        public PatentMortgageRefusalLetter(Filling model, string url, Receipt receipt, ApplicationInfo application)
        {
            this.model = model;
            this.url = url;
        ...
        private void ComposeContent(IContainer container)
        {
            container.Column(col =>
            {
                ...
                col.Item().AlignCenter().PaddingBottom(10)
                    ...
                    .FontFamily(Fonts.TimesNewRoman).FontSize(14);
                col.Item().AlignCenter()
                    .Text("PATENT MORTGAGE REFUSAL LETTER")
