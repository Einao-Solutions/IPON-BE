...
{
    public class RegUsersReceipt(Filling model, string appId) : IDocument 
    {
        string nairaSymbol = "\u20A6";
        ...
        void ComposeContent(IContainer container)
        {
            container
                ...
                .Column(column =>
                {
                    ...
                    column.Item().AlignCenter().Text("REGISTERED USERS PAYMENT RECEIPT").FontColor(Colors.Green.Darken3).FontFamily(Fonts.TimesNewRoman).FontSize(16).ExtraBold();
                    ...
                    column.Item().Table(table =>
                    {
                        ...
                        string filingDate = DateTime.TryParse(app?.FilingDate, out var parsedDate)
                        ...
                        table.Cell().Element(Block).Column(c => {
                            ...
                            c.Item().Text($"{nairaSymbol}18,500").FontFamily(Fonts.TimesNewRoman);
                        });
                        table.Cell().Element(Block).Column(c => {
                        ...
                        table.Cell().Element(Block).Column(c => {
                            ...
                            c.Item().Text("CLD0021").FontSize(12).FontFamily(Fonts.TimesNewRoman);
                        });
                    });
