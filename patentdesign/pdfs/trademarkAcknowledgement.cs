...
{
    public class AcknowledgementModelTrademark(Filling model, string url, byte[] image, Receipt receipt) : IDocument
    {
        string nairaSymbol = "\u20A6";
        ...
        void ComposeContent(IContainer container)
        {
            ...
            container
                ...
                .Column(column =>
                {
                    ...
                    column.Item().AlignCenter().Text("TRADEMARK REGISTRATION ACKNOWLEDGEMENT LETTER").FontColor(Colors.Green.Darken3).FontFamily(Fonts.TimesNewRoman).FontSize(16).ExtraBold();
