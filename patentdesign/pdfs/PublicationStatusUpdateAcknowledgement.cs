...
{
    public class PublicationStatusUpdateAcknowledgement(Filling model, byte[] image, ApplicationInfo selectedHistory) : IDocument
    {
        ...
        void ComposeContent(IContainer container)
        {
            ...
            container
                ...
                .Column(column =>
                {
                    ...
                    {
                        FileTypes.TradeMark => "PUBLICATION STATUS UPDATE ACKNOWLEDGEMENT LETTER",
                   ...
                   // Unique Section per File Type
                    ...
                    //;
                    column.Item().Height(10);
                    column.Item().AlignCenter().Text("YOUR APPLICATION HAS BEEN RECEIVED AND IS RECEIVING DUE ATTENTION").FontColor(Colors.Green.Darken2).FontFamily(Fonts.TimesNewRoman).FontSize(14).Bold();
