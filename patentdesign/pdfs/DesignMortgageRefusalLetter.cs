...
{
    public class DesignMortgageRefusalLetter : IDocument
    {
        ...
        public DesignMortgageRefusalLetter(Filling model, string url, Receipt receipt, ApplicationInfo application)
        {
            this.model = model;
            this.url = url;
        ...
        private void ComposeContent(IContainer container)
        {
            container.Column(col =>
            {
                ...
                col.Item().AlignCenter().PaddingBottom(10)
                    ...
                    .FontFamily(Fonts.TimesNewRoman).FontSize(14);
                col.Item().AlignCenter()
                    .Text("DESIGN MORTGAGE REFUSAL LETTER")
                ...
                var mortgageRecordal = model.PostRegApplications?
                    .FirstOrDefault(p => p.RecordalType == "Design Mortgage Recordal");
